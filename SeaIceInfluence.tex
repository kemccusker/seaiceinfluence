...
The control simulation with observed boundary conditions is forced with repeating 1979-1989 HadISST1.1 climatologies of SIC and SST and is known as \textbf{CTLobs}. CTLobs sea ice thickness boundary condition data is obtained from the output of a previous CanAM model version (@@). The perturbation simulation, known as \textbf{PTobs}, is forced with repeating 2002-2011 HadISST1.1 climatologies of SIC, and 1979-1989 SST everywhere except where SIC declines by 10\% or more, in which case SST is the 2002-2011 climatology. In this way, only changes in SST directly attributed to changes in sea ice are incorporated. This method has been previously used in Screen@@, Peings and Magnusdottir@@. The PTobs SIT boundary condition is the same as for CTLobs, except where SIC disappears, SIT is set to zero @@. We discuss the relative importance of including changes in both local SST and sea-ice thickness in Section @@.
