...
Sat response is similar to PM14 DJF and SD14 SON and DJF. \\
Although difficult to discern from the figures, HAD Z500 in DJF resembles the results of P\&M14 in that they both have a small, statistically significant high over the BKS, but our study lacks the significant region of high height over the Atlantic from about 30-45N. Additionally, Screen et al 2013 (JClim) find Z500 highs over the N. Atlantic/Greenland in early winter that are not significant, similar to our results, but only show a high near BKS in CAM3 (not UM7.3) in S-O. Note that these studies are not directly comparable as they have different periods of sea ice forcing and SD13 is transient.\\
